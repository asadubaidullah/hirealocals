...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{
  ...
  return {
    ...
    openGraph:{type:"article",url:`/blog/${p.slug}`,title:p.meta_title||p.title,description:p.meta_description||p.excerpt,images:p.image_url?[{url:p.image_url,alt:p.title}]:[],publishedTime:p.published_at||undefined,modifiedTime:p.updated_at||undefined},
    twitter:{card:"summary_large_image",title:p.meta_title||p.title,description:p.meta_description||p.excerpt,images:p.image_url?[p.image_url]:[]}
  };
}
