...
import DeferredFloatingWidgets from "@/components/DeferredFloatingWidgets";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html data-scroll-behavior="smooth" lang="en" suppressHydrationWarning>
      <head>
        <link rel="preload" as="image" href="/images/home/hero-home-pexels-mobile.webp" type="image/webp" media="(max-width: 768px)" fetchPriority="high" />
        <link rel="preload" as="image" href="/images/home/hero-home-pexels.webp" type="image/webp" media="(min-width: 769px)" fetchPriority="high" />
        <link rel="preconnect" href="https://api.hirealocals.com" crossOrigin="anonymous" />
        <link rel="dns-prefetch" href="https://api.hirealocals.com" />
